...
/*
 ...
 2)We need interface to be create "Multiple interface Parents" for a class
 3)All  methods must be "abstract" in interface, because of that "interfaces" are used for "fully abstraction"
  Note: We can use "abstract" and "concrete" method together in "abstract classes" because of that using 
  "abstract class" is called "partial abstraction". 
 4)Do not use abstract keywords when you create interface. Because Java knows interfaces are abstract.
 5)All methods are "abstract" as a a default in an interface, because of that using "abstract" keyword optional 
 in interface. So "public abstract void electronicAc();" and "public void electronicAc();" are completely same.
