...
public class KitapBilgileri {
	...
	public KitapBilgileri(int kitapNo, String kitapAdi, String yazarAdi,
			double kitapFiyati) {
	...
	public void kitapEkle() {
		...
		KitapBilgileri kitapEkle = new KitapBilgileri(kitapNo, kitapAdi, 
				yazarAdi, kitapFiyati);
	...
	public void numaraIleKitapListele() {
		...
		System.out.println("Lutfen listelenmesini istediginiz kitap "
				+ "numarasini giriniz: ");
		int no = scan.nextInt();
		scan.nextLine();
	...
	public void bilgiIleKitapListele() {
		...
		System.out.println("Lutfen listelenmesini istediginiz "
				+ "kitabin adini ya da yazarini giriniz: ");
	...
	public void numaraIleKitapSil() {
		...
		System.out.println("Lutfen silinmesini istediginiz"
				+ " kitap numarasini giriniz: ");
		...
		for (KitapBilgileri w : kitapListesi) {
			...
			if (w.kitapNo == silNo) {
				...
				System.out.println(w + "Bu kitap ve bilgileri "
						+ "listeden kaldirilmistir!");
	...
	public String toString() {
		return "KitapBilgileri [kitapNo=" + kitapNo + ", kitapAdi=" + kitapAdi + ", yazarAdi=" + yazarAdi
				+ ", kitapFiyati=" + kitapFiyati + ", kitapListesi=" + kitapListesi + "]";
	}
