...
public class Hashmap01 {
	...
	public static void main(String[] args) {
		...
		// According to Java "Java" and "Java." are different words but in our task they
		// should be same
		...
		System.out.println(Arrays.toString(words));// [java, is, easy, type, codes, to, learn, java, to, earn, money,
													// learn, java]
