package day21accessmodifiersstringbulider;

public class Varargs01 {	
	public static void main(String[] args) {

		System.out.println("The sum empty: " + add());//0		
		System.out.println("The sum single: " + add(7));		
		System.out.println("The sum two: " + add(7, 9));		
		System.out.println("The sum multi: " + add(7, 9, 10, 11, 1, 2, 13, 14, 15));
